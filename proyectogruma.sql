...
-- Volcando datos para la tabla proyectogruma.cat_imagenes: ~35 rows (aproximadamente)
INSERT INTO `cat_imagenes` (`id`, `nombre`, `url`, `nombre_archivo`, `activo`, `registro`) VALUES
	(1, 'ARROZ', 'assets/img/productos/', 'lusiana_arroz.png', 1, '2026-05-08'),
	(2, 'ATOMIX ', 'assets/img/productos/', 'mission_atomix.png', 1, '2026-05-08'),
	(3, 'ATOMIX ', 'assets/img/productos/', 'mission_chile.png', 1, '2026-05-08'),
	(4, 'BOLITAS DE QUESO', 'assets/img/productos/', 'tosty_bolitas.png', 1, '2026-05-08'),
	(5, 'CACAHUATES JAPONES', 'assets/img/productos/', 'rumba_japones.png', 1, '2026-05-08'),
	(6, 'CHIRULITOS', 'assets/img/productos/', 'tosty_palitos.png', 1, '2026-05-08'),
	(7, 'FRIJOL ', 'assets/img/productos/', 'lusiana_frijol.png', 1, '2026-05-08'),
	(8, 'FRIJOL COLADO', 'assets/img/productos/', 'lusiana_2.png', 1, '2026-05-08'),
	(9, 'HARINA DE MAÍZ', 'assets/img/productos/', 'harina_maseca.png', 1, '2026-05-08'),
	(10, 'HORNEADAS', 'assets/img/productos/', 'mission_horneadas.png', 1, '2026-05-08'),
	(11, 'MASECA AMARILLA', 'assets/img/productos/', 'maseca_amarillo.png', 1, '2026-05-08'),
	(12, 'MASECA ANTOJITOS', 'assets/img/productos/', 'maseca_antojitos.png', 1, '2026-05-08'),
	(13, 'MASECA AZUL', 'assets/img/productos/', 'maseca_azul.png', 1, '2026-05-08'),
	(14, 'NORTEÑAS AMARILLAS', 'assets/img/productos/', 'norteñas_amarillas.png', 1, '2026-05-08'),
	(15, 'PALMITO', 'assets/img/productos/', 'cima_1.png', 1, '2026-05-08'),
	(16, 'PALMITO', 'assets/img/productos/', 'cima_2.png', 1, '2026-05-08'),
	(17, 'PALMITO', 'assets/img/productos/', 'cima_3.png', 1, '2026-05-08'),
	(18, 'PALMITO SPAGUETI', 'assets/img/productos/', 'cima_4.png', 1, '2026-05-08'),
	(19, 'PALOMITAS CHEDDAR', 'assets/img/productos/', 'tosty_cheddar.png', 1, '2026-05-08'),
	(20, 'PALOMITAS MANTEQUILLA', 'assets/img/productos/', 'tosty_mantequilla.png', 1, '2026-05-08'),
	(21, 'PALOMITAS NATURAL', 'assets/img/productos/', 'tosty_natural.png', 1, '2026-05-08'),
	(22, 'PIKITOS', 'assets/img/productos/', 'rumba_pikitos.png', 1, '2026-05-08'),
	(23, 'QUESITOS', 'assets/img/productos/', 'tosty_quesitos.png', 1, '2026-05-08'),
	(24, 'RUMBA PATACONES', 'assets/img/productos/', 'rumba_patacones.png', 1, '2026-05-08'),
	(25, 'RUMBA RICO', 'assets/img/productos/', 'rumba_tico.png', 1, '2026-05-08'),
	(26, 'TORTILLA CHIPS', 'assets/img/productos/', 'tortilla_chips.png', 1, '2026-05-08'),
	(27, 'TORTILLAS', 'assets/img/productos/', 'guerrero_tortillas.png', 1, '2026-05-08'),
	(28, 'TORTILLAS', 'assets/img/productos/', 'fogon_tortillas.png', 1, '2026-05-08'),
	(29, 'TORTILLAS DE MAÍZ BLANCO', 'assets/img/productos/', 'tortilla.png', 1, '2026-05-08'),
	(30, 'TORTILLAS DE TRIGO', 'assets/img/productos/', 'tortillas_de_trigo.png', 1, '2026-05-08'),
	(31, 'TOSTADAS', 'assets/img/productos/', 'guerrero_tostadas.png', 1, '2026-05-08'),
	(32, 'TOSTADAS', 'assets/img/productos/', 'rumba_tostadas.png', 1, '2026-05-08'),
	(33, 'TOSTADAS', 'assets/img/productos/', 'fogon_tostadas.png', 1, '2026-05-08'),
	(34, 'TOSTADAS CASERAS', 'assets/img/productos/', 'tostadas_caseras.png', 1, '2026-05-08'),
	(35, 'TRONADITAS', 'assets/img/productos/', 'tosty_tronaditas.png', 1, '2026-05-08');
...
-- Volcando datos para la tabla proyectogruma.historia: ~4 rows (aproximadamente)
INSERT INTO `historia` (`id`, `titulo`, `subtitulo`, `descripcion`, `anio`, `imagen`, `tipo`, `orden`, `activo`) VALUES
	...
	(3, 'Plantas', '', '72 Plantas ', '200', 'planta.jpg', 'timeline', 2, 1),
	(4, 'Capacidad instalada', NULL, '2.3 millones de toneladas', '2000', 'planta.jpg', 'timeline', 3, 1),
	(5, 'Almacenes', NULL, '65 Almacenes ', '2000', 'planta.jpg', 'timeline', 4, 1);
